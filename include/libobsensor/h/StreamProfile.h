 ...
 *
 * @param[in] scan_speed The scan speed LiDAR
 * @param[in] format The format of the LiDAR stream
 * @param[out] error Pointer to an error object that will be set if an error occurs.
 * @return ob_stream_profile* return the accel stream profile object
 */
OB_EXPORT ob_stream_profile *ob_create_lidar_stream_profile(ob_lidar_scan_speed scan_speed, ob_format format, ob_error **error);
...
/**
 * @brief Get the scan speed of the LiDAR stream.
 *
 * @param[in] profile Stream profile object. If the profile is not for the LiDAR stream, an error will be returned.
 * @param[out] error Pointer to an error object that will be set if an error occurs.
 * @return The scan speed of the LiDAR stream.
 */
OB_EXPORT ob_lidar_scan_speed ob_lidar_stream_profile_get_scan_speed(const ob_stream_profile *profile, ob_error **error);
 ...
 *
 * @param[in] profile_list Resolution list.
 * @param scan_speed[in] The scan speed LiDAR. If you don't need to add matching conditions, you can pass OB_LIDAR_SCAN_ANY.
 * @param format[in] The format of the LiDAR stream. If you don't need to add matching conditions, you can pass OB_FORMAT_ANY.
 * @param[out] error Pointer to an error object that will be set if an error occurs.
 * @return The matching profile.
 */
OB_EXPORT ob_stream_profile *ob_stream_profile_list_get_lidar_stream_profile(const ob_stream_profile_list *profile_list, ob_lidar_scan_speed scan_speed,
