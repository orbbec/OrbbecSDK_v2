...
const std::map<uint32_t, OBPropertyBaseInfo> OBPropertyBaseInfoMap = {
    ...
    PROP_INFO_PAIR(OB_RAW_DATA_LIDAR_SERIAL_NUMBER, OB_STRUCT_PROPERTY),
    PROP_INFO_PAIR(OB_PROP_LIDAR_ECHO_MODE_INT, OB_INT_PROPERTY),
    ...
    PROP_INFO_PAIR(OB_PROP_LIDAR_SAVE_MEMS_PARAM_INT, OB_INT_PROPERTY),
    ...
    PROP_INFO_PAIR(OB_PROP_LIDAR_MCU_TEMPERATURE_FLOAT, OB_FLOAT_PROPERTY),
    PROP_INFO_PAIR(OB_PROP_LIDAR_FPGA_TEMPERATURE_FLOAT, OB_FLOAT_PROPERTY),
    PROP_INFO_PAIR(OB_RAW_DATA_LIDAR_MOTOR_VERSION, OB_STRUCT_PROPERTY),
    PROP_INFO_PAIR(OB_PROP_LIDAR_APD_HIGH_VOLTAGE_FLOAT, OB_FLOAT_PROPERTY),
    PROP_INFO_PAIR(OB_PROP_LIDAR_APD_TEMPERATURE_FLOAT, OB_FLOAT_PROPERTY),
    PROP_INFO_PAIR(OB_PROP_LIDAR_TX_HIGH_POWER_VOLTAGE_FLOAT, OB_FLOAT_PROPERTY),
    PROP_INFO_PAIR(OB_PROP_LIDAR_TX_LOWER_POWER_VOLTAGE_FLOAT, OB_FLOAT_PROPERTY),
