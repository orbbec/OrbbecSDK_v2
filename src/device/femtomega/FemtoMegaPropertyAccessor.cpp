...
FemtoMegaFrameTransformPropertyAccessor::FemtoMegaFrameTransformPropertyAccessor(IDevice *owner) : owner_(owner) {}

void FemtoMegaFrameTransformPropertyAccessor::setPropertyValue(uint32_t propertyId, const OBPropertyValue &value) {
    switch(propertyId) {
...
void FemtoMegaFrameTransformPropertyAccessor::getPropertyValue(uint32_t propertyId, OBPropertyValue *value) {
    if(!value) {
...
void FemtoMegaFrameTransformPropertyAccessor::getPropertyRange(uint32_t propertyId, OBPropertyRange *range) {
    if(range == nullptr) {
