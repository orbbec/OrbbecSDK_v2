...
| stream   | [callback](1.stream.decimation)                         | Use the SDK interface to configure device preset resolutions, select decimation profiles for sensors, and display them in the window. |                                                                                                                                               |
